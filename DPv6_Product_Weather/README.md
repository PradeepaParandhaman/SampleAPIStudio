...
- **WeatherApi.yml** - API asset
- **WeatherApi-spec.json** - API specifications
...
- **Sanity_Test.yml** - Sanity test for the WeatherApi
...
6. For executing the tests, replace the "ClientIdDpv6" variable value in the environment file under tests with the key from the created application.
